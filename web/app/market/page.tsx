  ...
  return (
    ...
    >
      {isBookmarked ? (
        ...
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-4 w-4 text-muted hover:text-value-text">
...
function CollectionStateRibbon({ collection }: { collection: SoulCollectionAssetSummary }) {
  ...
  return (
    <div className="flex items-center gap-2 border-b border-teal/35 bg-teal/10 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.08em] text-tech-text">
      <span aria-hidden="true">◆</span>
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-[20px] border border-border bg-transparent px-3.5 py-1.5 text-xs font-semibold text-muted transition-colors hover:border-purple hover:text-action-label cursor-pointer select-none"
          >
                  ...
                  >
                    ...
                    >
                      {soul.collectionOnChainId && (
                        <span className="absolute left-2 top-2 inline-flex items-center gap-1 rounded-full border border-white/15 bg-[rgba(13,10,30,0.72)] px-2 py-[3px] text-[10.5px] font-semibold text-white/80 backdrop-blur-sm">
                          from collection ↗
                        </span>
                      )}
                    </SoulCoverImage>
