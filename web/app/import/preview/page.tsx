      ...
      <PageContainer size="md" className="space-y-5 pt-7 sm:pt-9">
        ...
        <div className="rounded-2xl border border-purple/30 bg-purple/6 p-5">
          ...
          <p className="mb-4 text-xs leading-relaxed text-muted">
            Imported provenance stays visible, while the new Soul content follows the same sealed character, encrypted founding memory, and private-by-default skills model as native minting. Persona sprites are added after mint from the Soul detail page. Live memory grows later through grant-authorized writes on Walrus.
          </p>
