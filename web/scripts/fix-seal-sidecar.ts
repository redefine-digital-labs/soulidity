 ...
 *
 * Usage:
 *   source .env && SOUL_ON_CHAIN_ID="0x..." npx tsx web/scripts/fix-seal-sidecar.ts
 */
...
async function main() {
  if (!SOUL_ON_CHAIN_ID || !DATABASE_URL) {
    console.error('Usage: source .env && SOUL_ON_CHAIN_ID=0x... npx tsx web/scripts/fix-seal-sidecar.ts')
    process.exit(1)
  }
