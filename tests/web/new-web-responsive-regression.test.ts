...
describe('web responsive regression guards', () => {
  ...
  it('keeps the landing hero ctas and stats mobile-friendly', () => {
    const source = readSource('web/app/page.tsx')
  ...
  it('stacks market controls before widening into rows', () => {
    const source = readSource('web/app/market/page.tsx')
  ...
  it('stacks step actions on narrow screens in the create and import flows', () => {
    ...
    const importUploadSource = readSource('web/app/import/upload/page.tsx')
