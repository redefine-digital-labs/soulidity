...
- Modify: `docs/superpowers/specs/2026-03-26-legacy-compat-cleanup-spec.md`
...
```bash
git add LEGACY_COMPAT_AUDIT.md docs/superpowers/specs/2026-03-26-legacy-compat-cleanup-spec.md docs/test-plan-auth.md
...
Confirm the implementation satisfies all six acceptance items in `docs/superpowers/specs/2026-03-26-legacy-compat-cleanup-spec.md`.
