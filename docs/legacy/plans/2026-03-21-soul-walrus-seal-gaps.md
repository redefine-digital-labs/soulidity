...
> Historical planning note. It predates the latest allowlist single-address Soul semantics; any `grant` / subscription wording is retained for traceability only.
