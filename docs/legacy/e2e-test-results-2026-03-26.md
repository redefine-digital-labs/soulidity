...
| 12 | Set Agent Alpha allowlist for Soul A (perpetual pass) | ✅ |
| 13 | Set Agent Beta allowlist for Soul B (subscription pass) | ✅ |
...
- `docs/legacy/e2e-screenshots/phase1-souls-page.png` — 清空后列表页
...
- `docs/legacy/e2e-screenshots/phase3-grants-complete.png` — 两个 Agent allowlist 完成
